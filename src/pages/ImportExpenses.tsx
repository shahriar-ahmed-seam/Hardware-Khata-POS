...
export default function ImportExpenses() {
  ...
  const handleFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFileName(f.name);
    setTimeout(() => {
      setStats({ rows: 24, valid: 24, errors: 0 });
      setStage('review');
    }, 200);
  };
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Bulk-import expenses via CSV"
        actions={
      ...
      <div className="p-6 max-w-3xl space-y-4">
        <Card className="p-6 text-sm space-y-2">
          ...
          <ul className="text-xs text-muted-foreground space-y-1 list-disc pl-5">
            <li>
              <code>category</code> matches a top-level category by name; unknown ones are
              created.
            </li>
            <li>
              <code>subcategory</code> optional; if present, attached under the named parent.
            </li>
            <li>
              <code>payment_method</code> ∈ Cash / bKash / Nagad / Card / Bank / Cheque.
            </li>
            <li>
              <code>date</code> in <code>YYYY-MM-DD HH:mm</code>.
            </li>
            <li>
        ...
        <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                <Button onClick={() => setStage('done')} disabled={stats.valid === 0}>
                  Import {stats.valid} expense{stats.valid === 1 ? '' : 's'}
                </Button>
              </div>
            </div>
          )}
          ...
          {stage === 'done' && (
            <div className="text-center py-8">
              ...
              <div className="mt-3 text-lg font-semibold">Expenses imported</div>
