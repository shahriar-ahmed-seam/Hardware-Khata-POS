...
- **Bangla throughout** — a 2,405-phrase dictionary, toggled from the title bar. It translates
...
the 1,108 automated checks exists to defend them.
...
**1,108 automated checks across eight suites**, run against real SQLite databases — including a
...
npm run backend:verify:all   # 1,108 checks (rebuilds native deps for Node first)
