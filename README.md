...
- **Bangla throughout** — a 2,385-phrase dictionary, toggled from the title bar. It translates
...
the 1,078 automated checks exists to defend them.
...
**1,078 automated checks across seven suites**, run against real SQLite databases — including a
...
npm run backend:verify:all   # 1,078 checks (rebuilds native deps for Node first)
